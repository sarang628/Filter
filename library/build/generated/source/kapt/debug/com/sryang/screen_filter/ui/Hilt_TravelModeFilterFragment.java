...
public abstract class Hilt_TravelModeFilterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TravelModeFilterFragment() {
    super();
  }

  Hilt_TravelModeFilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TravelModeFilterFragment_GeneratedInjector) this.generatedComponent()).injectTravelModeFilterFragment(UnsafeCasts.<TravelModeFilterFragment>unsafeCast(this));
    }
  }
