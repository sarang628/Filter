...
public abstract class Hilt_RatingFilterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RatingFilterFragment() {
    super();
  }

  Hilt_RatingFilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RatingFilterFragment_GeneratedInjector) this.generatedComponent()).injectRatingFilterFragment(UnsafeCasts.<RatingFilterFragment>unsafeCast(this));
    }
  }
