...
public abstract class Hilt_PriceFilterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PriceFilterFragment() {
    super();
  }

  Hilt_PriceFilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PriceFilterFragment_GeneratedInjector) this.generatedComponent()).injectPriceFilterFragment(UnsafeCasts.<PriceFilterFragment>unsafeCast(this));
    }
  }
