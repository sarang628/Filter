 ...
 */
public abstract class Hilt_FilterParentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilterParentFragment() {
    super();
  }

  Hilt_FilterParentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilterParentFragment_GeneratedInjector) this.generatedComponent()).injectFilterParentFragment(UnsafeCasts.<FilterParentFragment>unsafeCast(this));
    }
  }
