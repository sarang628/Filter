...
public class FragmentDistanceFilterBindingImpl extends FragmentDistanceFilterBinding implements com.sryang.screen_filter.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setDistance((com.example.torang_core.data.model.Distances) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setDistance(@Nullable com.example.torang_core.data.model.Distances Distance) {
    ...
    protected void executeBindings() {
        ...
        com.example.torang_core.data.model.Distances distance = mDistance;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                distanceDistances100M = (distance) == (com.example.torang_core.data.model.Distances._100M);
                // read distance == Distances._300M
                distanceDistances300M = (distance) == (com.example.torang_core.data.model.Distances._300M);
                // read distance == Distances._500M
                distanceDistances500M = (distance) == (com.example.torang_core.data.model.Distances._500M);
                // read distance == Distances._3KM
                distanceDistances3KM = (distance) == (com.example.torang_core.data.model.Distances._3KM);
                // read distance == Distances._1KM
                distanceDistances1KM = (distance) == (com.example.torang_core.data.model.Distances._1KM);
        }
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.example.torang_core.util.BindingAdapterKt.select(this.textView, distanceDistances100M);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView11, distanceDistances1KM);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView12, distanceDistances3KM);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView2, distanceDistances300M);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView3, distanceDistances500M);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1
