...
public class FragmentRatingFilterBindingImpl extends FragmentRatingFilterBinding implements com.sryang.screen_filter.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setRatings((java.util.ArrayList<com.example.torang_core.data.model.Ratings>) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setRatings(@Nullable java.util.ArrayList<com.example.torang_core.data.model.Ratings> Ratings) {
    ...
    protected void executeBindings() {
        ...
        java.util.ArrayList<com.example.torang_core.data.model.Ratings> ratings = mRatings;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                if (ratings != null) {
                    ...
                    ratingsContainsRatingsFOUR = ratings.contains(com.example.torang_core.data.model.Ratings.FOUR);
                    // read ratings.contains(Ratings.FIVE)
                    ratingsContainsRatingsFIVE = ratings.contains(com.example.torang_core.data.model.Ratings.FIVE);
                    // read ratings.contains(Ratings.THREE)
                    ratingsContainsRatingsTHREE = ratings.contains(com.example.torang_core.data.model.Ratings.THREE);
                    // read ratings.contains(Ratings.ONE)
                    ratingsContainsRatingsONE = ratings.contains(com.example.torang_core.data.model.Ratings.ONE);
                    // read ratings.contains(Ratings.TWO)
                    ratingsContainsRatingsTWO = ratings.contains(com.example.torang_core.data.model.Ratings.TWO);
                }
        }
        // batch finished
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.example.torang_core.util.BindingAdapterKt.select(this.textView10, ratingsContainsRatingsFIVE);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView4, ratingsContainsRatingsONE);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView5, ratingsContainsRatingsTWO);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView6, ratingsContainsRatingsTHREE);
            com.example.torang_core.util.BindingAdapterKt.select(this.textView9, ratingsContainsRatingsFOUR);
        }
