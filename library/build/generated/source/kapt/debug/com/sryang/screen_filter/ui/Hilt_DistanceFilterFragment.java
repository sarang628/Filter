...
public abstract class Hilt_DistanceFilterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DistanceFilterFragment() {
    super();
  }

  Hilt_DistanceFilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DistanceFilterFragment_GeneratedInjector) this.generatedComponent()).injectDistanceFilterFragment(UnsafeCasts.<DistanceFilterFragment>unsafeCast(this));
    }
  }
