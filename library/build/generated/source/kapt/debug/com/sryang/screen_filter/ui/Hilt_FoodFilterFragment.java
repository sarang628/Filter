...
public abstract class Hilt_FoodFilterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodFilterFragment() {
    super();
  }

  Hilt_FoodFilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodFilterFragment_GeneratedInjector) this.generatedComponent()).injectFoodFilterFragment(UnsafeCasts.<FoodFilterFragment>unsafeCast(this));
    }
  }
