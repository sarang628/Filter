...
public class FragmentFoodFilterBindingImpl extends FragmentFoodFilterBinding implements com.sryang.screen_filter.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setSelectedRestaurantType((java.util.ArrayList<com.sryang.torang_core.data.entity.RestaurantType>) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSelectedRestaurantType(@Nullable java.util.ArrayList<com.sryang.torang_core.data.entity.RestaurantType> SelectedRestaurantType) {
    ...
    protected void executeBindings() {
        ...
        java.util.ArrayList<com.sryang.torang_core.data.entity.RestaurantType> selectedRestaurantType = mSelectedRestaurantType;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                if (selectedRestaurantType != null) {
                    ...
                    selectedRestaurantTypeContainsRestaurantTypeKOREAN = selectedRestaurantType.contains(com.sryang.torang_core.data.entity.RestaurantType.KOREAN);
                    // read selectedRestaurantType.contains(RestaurantType.FOREIGN)
                    selectedRestaurantTypeContainsRestaurantTypeFOREIGN = selectedRestaurantType.contains(com.sryang.torang_core.data.entity.RestaurantType.FOREIGN);
                    // read selectedRestaurantType.contains(RestaurantType.DRINK)
                    selectedRestaurantTypeContainsRestaurantTypeDRINK = selectedRestaurantType.contains(com.sryang.torang_core.data.entity.RestaurantType.DRINK);
                    // read selectedRestaurantType.contains(RestaurantType.JAPANESE)
                    selectedRestaurantTypeContainsRestaurantTypeJAPANESE = selectedRestaurantType.contains(com.sryang.torang_core.data.entity.RestaurantType.JAPANESE);
                    // read selectedRestaurantType.contains(RestaurantType.CHINESE)
                    selectedRestaurantTypeContainsRestaurantTypeCHINESE = selectedRestaurantType.contains(com.sryang.torang_core.data.entity.RestaurantType.CHINESE);
                }
        }
        // batch finished
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView10, selectedRestaurantTypeContainsRestaurantTypeDRINK);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView4, selectedRestaurantTypeContainsRestaurantTypeKOREAN);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView5, selectedRestaurantTypeContainsRestaurantTypeCHINESE);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView6, selectedRestaurantTypeContainsRestaurantTypeFOREIGN);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView9, selectedRestaurantTypeContainsRestaurantTypeJAPANESE);
        }
        ...
        switch(sourceId) {
            case 5: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setFood(com.sryang.torang_core.data.entity.RestaurantType.DRINK);
                }
                break;
            }
            case 3: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setFood(com.sryang.torang_core.data.entity.RestaurantType.FOREIGN);
                }
                break;
            }
            case 1: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setFood(com.sryang.torang_core.data.entity.RestaurantType.KOREAN);
                }
                break;
            }
            case 4: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setFood(com.sryang.torang_core.data.entity.RestaurantType.JAPANESE);
                }
                break;
            }
            case 2: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setFood(com.sryang.torang_core.data.entity.RestaurantType.CHINESE);
                }
                break;
            }
        }
