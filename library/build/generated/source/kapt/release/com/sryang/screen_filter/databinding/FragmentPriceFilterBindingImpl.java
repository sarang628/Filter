...
public class FragmentPriceFilterBindingImpl extends FragmentPriceFilterBinding implements com.sryang.screen_filter.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            ...
            setPrice((com.sryang.torang_core.data.entity.Prices) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPrice(@Nullable com.sryang.torang_core.data.entity.Prices Price) {
        this.mPrice = Price;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.sryang.torang_core.data.entity.Prices price = mPrice;
        ...
        if ((dirtyFlags & 0x4L) != 0) {
                ...
                pricesAROUND20KToName = com.sryang.torang_core.data.entity.Prices.AROUND_20K.getToName();
                // read Prices.AROUND_10K.toName
                pricesAROUND10KToName = com.sryang.torang_core.data.entity.Prices.AROUND_10K.getToName();
                // read Prices.AROUND_30K.toName
                pricesAROUND30KToName = com.sryang.torang_core.data.entity.Prices.AROUND_30K.getToName();
                // read Prices.OVER_30K.toName
                pricesOVER30KToName = com.sryang.torang_core.data.entity.Prices.OVER_30K.getToName();
                // read Prices.UNDER_10K.toName
                pricesUNDER10KToName = com.sryang.torang_core.data.entity.Prices.UNDER_10K.getToName();
        }
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                pricePricesAROUND20K = (price) == (com.sryang.torang_core.data.entity.Prices.AROUND_20K);
                // read price == Prices.UNDER_10K
                pricePricesUNDER10K = (price) == (com.sryang.torang_core.data.entity.Prices.UNDER_10K);
                // read price == Prices.AROUND_10K
                pricePricesAROUND10K = (price) == (com.sryang.torang_core.data.entity.Prices.AROUND_10K);
                // read price == Prices.AROUND_30K
                pricePricesAROUND30K = (price) == (com.sryang.torang_core.data.entity.Prices.AROUND_30K);
                // read price == Prices.OVER_30K
                pricePricesOVER30K = (price) == (com.sryang.torang_core.data.entity.Prices.OVER_30K);
        }
        // batch finished
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1

            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView10, pricePricesOVER30K);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView4, pricePricesUNDER10K);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView5, pricePricesAROUND10K);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView6, pricePricesAROUND20K);
            com.sryang.torang_core.util.BindingAdapterKt.select(this.textView9, pricePricesAROUND30K);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1
        ...
        switch(sourceId) {
            case 4: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setSelectedPrice(com.sryang.torang_core.data.entity.Prices.AROUND_30K);
                }
                break;
            }
            case 2: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setSelectedPrice(com.sryang.torang_core.data.entity.Prices.AROUND_10K);
                }
                break;
            }
            case 3: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setSelectedPrice(com.sryang.torang_core.data.entity.Prices.AROUND_20K);
                }
                break;
            }
            case 5: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setSelectedPrice(com.sryang.torang_core.data.entity.Prices.OVER_30K);
                }
                break;
            }
            case 1: {
                ...
                if (vmJavaLangObjectNull) {
                    ...
                    vm.setSelectedPrice(com.sryang.torang_core.data.entity.Prices.UNDER_10K);
                }
                break;
            }
        }
