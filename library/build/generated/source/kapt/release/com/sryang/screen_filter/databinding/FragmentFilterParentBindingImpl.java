...
public class FragmentFilterParentBindingImpl extends FragmentFilterParentBinding implements com.sryang.screen_filter.generated.callback.OnClickListener.Listener {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeFilterViewModelSelected((kotlinx.coroutines.flow.StateFlow<com.sryang.torang_core.data.NationItem>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeFilterViewModelSelected(kotlinx.coroutines.flow.StateFlow<com.sryang.torang_core.data.NationItem> FilterViewModelSelected, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        kotlinx.coroutines.flow.StateFlow<com.sryang.torang_core.data.NationItem> filterViewModelSelected = null;
        com.sryang.torang_core.data.NationItem filterViewModelSelectedGetValue = null;
